...
<html lang="zxx" dir="ltr">
    <head>
        ...
        <title>87 News</title>
        <meta name="description" content="87News a clean, modern and pixel-perfect multipurpose blogging HTML5 website template.">
        ...
        <meta property="og:title" content="87News">
        ...
        <meta property="og:site_name" content="87News">
        ...
        <meta name="twitter:title" content="87News">
        ...
        <!-- preload head styles -->
        <link rel="preload" href="https://html.themewant.com/news5/assets/css/unicons.min.css" as="style">
        <link rel="preload" href="https://html.themewant.com/news5/assets/css/swiper-bundle.min.css" as="style">

        <!-- preload footer scripts -->
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/libs/jquery.min.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/libs/scrollmagic.min.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/libs/swiper-bundle.min.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/libs/anime.min.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/helpers/data-attr-helper.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/helpers/swiper-helper.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/helpers/anime-helper.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/helpers/anime-helper-defined-timelines.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/uikit-components-bs.js" as="script">
        <link rel="preload" href="https://html.themewant.com/news5/assets/js/app.js" as="script">

        <!-- app head for bootstrap core -->
        <script src="https://html.themewant.com/news5/assets/js/app-head-bs.js"></script>

        <!-- include uni-core components -->
        <link rel="stylesheet" href="https://html.themewant.com/news5/assets/js/uni-core/css/uni-core.min.css">

        <!-- include styles -->
        <link rel="stylesheet" href="https://html.themewant.com/news5/assets/css/unicons.min.css">
        <link rel="stylesheet" href="https://html.themewant.com/news5/assets/css/prettify.min.css">
        <link rel="stylesheet" href="https://html.themewant.com/news5/assets/css/swiper-bundle.min.css">

        <!-- include main style -->        
        <link rel="stylesheet" href="https://html.themewant.com/news5/assets/css/theme/demo-two.min.css">

        <!-- include scripts -->
        <script src="https://html.themewant.com/news5/assets/js/uni-core/js/uni-core-bundle.min.js"></script>
    ...
    <body class="uni-body panel bg-white text-gray-900 dark:bg-black dark:text-gray-200 overflow-x-hidden">
                ...
                <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                    <div class="uc-logo">
                        <a href="index.html" class="h5 text-none text-gray-900 dark:text-white">
                            <img class=" uc-transition-scale-up uc-transition-opaque w-32px" src="https://html.themewant.com/news5/assets/images/common/logo-icon.svg" alt="News5" data-uc-svg>
                        </a>
                    </div>
                        ...
                        <div class="panel vstack gap-3">
                                ...
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="https://html.themewant.com/news5/assets/images/common/img-fallback.png" data-src="https://html.themewant.com/news5/assets/images/common/products/img-07.jpg" alt="Laptop Cover" data-uc-img="loading: lazy">
                            ...
                            <div>
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="https://html.themewant.com/news5/assets/images/common/img-fallback.png" data-src="https://html.themewant.com/news5/assets/images/common/products/img-08.jpg" alt="Disney Toys" data-uc-img="loading: lazy">
                            ...
                            <div>
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="https://html.themewant.com/news5/assets/images/common/img-fallback.png" data-src="https://html.themewant.com/news5/assets/images/common/products/img-09.jpg" alt="Screen Axe" data-uc-img="loading: lazy">
                            ...
                            <div>
                                <article class="product type-product panel">
                                    <div class="hstack gap-2">
                                        <figure class="featured-image m-0 ratio ratio-1x1 w-80px uc-transition-toggle overflow-hidden bg-gray-25 dark:bg-gray-800">
                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="https://html.themewant.com/news5/assets/images/common/img-fallback.png" data-src="https://html.themewant.com/news5/assets/images/common/products/img-10.jpg" alt="Airpods Pro" data-uc-img="loading: lazy">
                ...
                <div class="row md:child-cols-6 col-match g-0">
                    <div class="d-none md:d-flex">
                        <div class="position-relative w-100 ratio-1x1">
                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover" src="https://html.themewant.com/news5/assets/images/demo-two/common/newsletter.jpg" alt="Newsletter image">
                        </div>
                    </div>
                    <div>
        ...
        <!-- Header start -->
        <header class="uc-header header-two uc-navbar-sticky-wrap z-999" >
                        ...
                        <div class="uc-navbar min-h-72px lg:min-h-100px text-gray-900 dark:text-white" data-uc-navbar=" animation: uc-animation-slide-top-small; duration: 150;">
                            <!-- <div class="uc-navbar-left">
                                <div class="uc-logo text-black dark:text-white">
                                    <a href="index.html">
                                        <img class="text-dark dark:text-white" src="../img/IMG_20260327_001740.png" alt="News5" data-uc-svg width="200px">
                                    </a>
                                </div>
                            </div> -->
                           <!--  <div class="uc-navbar-left">
                    ...
                    <div class="container max-w-xl">
                        <div class="hstack">
                            <div class="uc-navbar-left gap-2 lg:gap-3 d-none lg:d-flex">                            
                                <div class="uc-logo text-black dark:text-white">
                                    <a href="index.html">
                                        <img class="text-dark dark:text-white" src="../img/logo.png" alt="87News" data-uc-svg width="130px" style="padding-top:15px; padding-bottom:15px;">
                                    </a>
                                </div>                                
                            </div>
                            <div class="uc-navbar-center gap-2 lg:gap-3">
                                <div class="uc-navbar-item" style="--uc-nav-height: 48px">
                                    <ul class="nav-x fw-semibold flex-nowrap overflow-x-auto hide-scrollbar uc-horizontal-scroll w-screen md:overflow-x-hidden md:w-auto md:mask-end-0 mx-n2 px-2 text-white">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="submenu fs-6">
                                                ...
                                                <li><a href="#">Seram Bagian Barat</a></li>
                                                <li><a href="#">Seram Bagian Timur</a></li>
                                                <li><a href="#">Tual</a></li>
                                    ...
                                    <ul class="uc-navbar-nav fs-5 fw-bold ms-2 d-none lg:d-flex text-white" style="--uc-nav-height: 72px">
                                        <li class="dropdown">
                                            <a href="#">
                                                <span>Daerah</span>
                                            </a>
                            ...
                            <div class="uc-navbar-right gap-2 lg:gap-3 d-none lg:d-flex">
                                <div class="uc-navbar-item">
                                    <a class="uc-search-trigger mb-narrow" href="#uc-search-modal" data-uc-toggle>
                                        <img class="text-white" src="https://html.themewant.com/news5/assets/images/common/icons/search.svg" alt="Search" data-uc-svg style="width: 20px">
                                    </a>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            <article class="post type-post panel vstack gap-3">
                                                                    ...
                                                                    <div class="post-meta panel hstack justify-center gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                        <div>
                                                                            <div class="post-category hstack gap-narrow fw-semibold">
                                                                                <a class="text-none hover:text-primary dark:text-primary duration-150" href="#">{{ $article->category->name }}</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sep d-none md:d-block">❘</div>
                                                                        <div class="d-none md:d-block">
                                                                            <div class="post-date hstack gap-narrow">
                                                                                <span>{{ $article->created_at->setTimezone('Asia/Tokyo')->locale('id')->translatedFormat('F d Y') }}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <h3 class="post-title h5 xl:h4 m-0 m-0 max-w-500px mx-auto">
                                                                        <a class="text-none" href="{{ route('article.show', $article->slug) }}">{{ $article->name }}</a>
                                                                    </h3>                                                                    
                                                                </div>
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-4x3">
                                                                        <img class="uc-transition-scale-up uc-transition-opaque media-cover image" src="{{ Storage::url($article->thumbnail) }}" data-src="{{ Storage::url($article->thumbnail) }}" alt="{{ $article->name }}" data-uc-img="loading: lazy">
                                                                    </div>
                                    ...
                                    <div class="lg:col-3 lg:order-1">
                                        <div class="block-layout panel">
                                            ...
                                            <div class="block-content panel row sep-x gx-4 gy-3 lg:gy-2">
                                                @foreach ($artikellanjutan as $artikel)
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">
                                                                {{ $artikel->created_at->timezone('Asia/Jayapura')->format('H:i') }}
                                                            </div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                            <a class="text-none hover:text-primary duration-150" href="{{ route('article.show', $artikel->slug) }}">{{ $artikel->name }}</a>
                                                        </h6>
                                                    </article>
                                                </div>
                                                @endforeach
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">10:23</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">09:30</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">09:10</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">08:00</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">22:00</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">14:15</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">16:30</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">20:00</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">12:00</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                ...
                                                <div>
                                                    <article class="post type-post panel d-flex gap-2">
                                                        <div>
                                                            <div class="fs-7 fw-bold text-center translate-y-narrow bg-gray-50 dark:bg-white dark:text-black min-w-48px">12:15</div>
                                                        </div>
                                                        <h6 class="fs-6 lg:fs-7 xl:fs-6 fw-medium text-truncate-2">
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-13.jpg" alt="Tech Tools for your Time Management: Enhancing Productivity" data-uc-img="loading: lazy">
                                                                    </div>
                                                    ...
                                                    <article class="post type-post panel">
                                                        <div class="row child-cols g-2" data-uc-grid>
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-14.jpg" alt="A Guide to The Rise of Gourmet Street Food: Trends and Top Picks" data-uc-img="loading: lazy">
                                                                    </div>
                                                                    <a href="blog-details.html" class="position-cover"></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <article class="post type-post panel vstack gap-2 lg:gap-3 h-100">
                                                        <div class="post-media panel uc-transition-toggle overflow-hidden h-100">
                                                            <div class="featured-image bg-gray-25 dark:bg-gray-800 h-100 d-none md:d-block">
                                                                ...
                                                                <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-15.jpg" alt="Gaming in the Age of AI: Strategies for Startups" data-uc-img="loading: lazy">
                                                            </div>
                                                        ...
                                                        <div class="post-header panel vstack justify-end items-start gap-1 sm:gap-2 p-2 sm:p-4 position-cover text-white">
                                                            ...
                                                            <div class="post-meta panel hstack justify-start gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                <div>
                                                                    <div class="post-category hstack gap-narrow fw-semibold">
                                                                        <a class="text-none hover:text-primary dark:text-primary duration-150" href="blog-category.html">Virtual Reality</a>
                                                                    </div>
                                                                </div>
                                                                <div class="sep d-none md:d-block">❘</div>
                                                                <div class="d-none md:d-block">
                                                    ...
                                                    <div class="row child-cols-6 g-1">
                                                            ...
                                                            <article class="post type-post panel vstack gap-2 lg:gap-3">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1 sm:ratio-4x3">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-11.jpg" alt="Solo Travel: Some Tips and Destinations for the Adventurous Explorer" data-uc-img="loading: lazy">
                                                                    </div>
                                                                </div>
                                                                <div class="position-cover bg-gradient-to-t from-black to-transparent opacity-90"></div>
                                                                <div class="post-header panel vstack justify-end items-start gap-1 p-2 position-cover text-white">
                                                                    ...
                                                                    <div class="post-meta panel hstack justify-start gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                        <div>
                                                                            <div class="post-category hstack gap-narrow fw-semibold">
                                                                                <a class="text-none hover:text-primary dark:text-primary duration-150" href="blog-category.html">Travel</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sep d-none md:d-block">❘</div>
                                                                        <div class="d-none md:d-block">
                                                        ...
                                                        <div>
                                                            <article class="post type-post panel vstack gap-2 lg:gap-3">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1 sm:ratio-4x3">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-12.jpg" alt="AI-Powered Financial Planning: How Algorithms Revolutionizing" data-uc-img="loading: lazy">
                                                                    </div>
                                                                </div>
                                                                <div class="position-cover bg-gradient-to-t from-black to-transparent opacity-90"></div>
                                                                <div class="post-header panel vstack justify-end items-start gap-1 p-2 position-cover text-white">
                                                                    ...
                                                                    <div class="post-meta panel hstack justify-start gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                        <div>
                                                                            <div class="post-category hstack gap-narrow fw-semibold">
                                                                                <a class="text-none hover:text-primary dark:text-primary duration-150" href="blog-category.html">Tech</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sep d-none md:d-block">❘</div>
                                                                        <div class="d-none md:d-block">
                                                        ...
                                                        <div>
                                                            <article class="post type-post panel vstack gap-2 lg:gap-3">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1 sm:ratio-4x3">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-13.jpg" alt="Tech Tools for your Time Management: Enhancing Productivity" data-uc-img="loading: lazy">
                                                                    </div>
                                                                </div>
                                                                <div class="position-cover bg-gradient-to-t from-black to-transparent opacity-90"></div>
                                                                <div class="post-header panel vstack justify-end items-start gap-1 p-2 position-cover text-white">
                                                                    <h3 class="post-title h6 sm:h5 lg:h6 xl:h5 m-0 max-w-600px text-white text-truncate-2">
                                                                        <a class="text-none text-white" href="blog-details.html">Tech Tools for your Time Management: Enhancing Productivity</a>
                                                                    </h3>
                                                                    <div class="post-meta panel hstack justify-start gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                        <div>
                                                                            <div class="post-category hstack gap-narrow fw-semibold">
                                                                                <a class="text-none hover:text-primary dark:text-primary duration-150" href="blog-category.html">Startups</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sep d-none md:d-block">❘</div>
                                                                        <div class="d-none md:d-block">
                                                        ...
                                                        <div>
                                                            <article class="post type-post panel vstack gap-2 lg:gap-3">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1 sm:ratio-4x3">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image uc-transition-scale-up uc-transition-opaque" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-14.jpg" alt="A Guide to The Rise of Gourmet Street Food: Trends and Top Picks" data-uc-img="loading: lazy">
                                                                    </div>
                                                                </div>
                                                                <div class="position-cover bg-gradient-to-t from-black to-transparent opacity-90"></div>
                                                                <div class="post-header panel vstack justify-end items-start gap-1 p-2 position-cover text-white">
                                                                    <h3 class="post-title h6 sm:h5 lg:h6 xl:h5 m-0 max-w-600px text-white text-truncate-2">
                                                                        <a class="text-none text-white" href="blog-details.html">A Guide to The Rise of Gourmet Street Food: Trends and Top Picks</a>
                                                                    </h3>
                                                                    <div class="post-meta panel hstack justify-start gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                        <div>
                                                                            <div class="post-category hstack gap-narrow fw-semibold">
                                                                                <a class="text-none hover:text-primary dark:text-primary duration-150" href="blog-category.html">AI Powered</a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sep d-none md:d-block">❘</div>
                                                                        <div class="d-none md:d-block">
                                    ...
                                    <div class="block-layout grid-layout vstack gap-2 lg:gap-3 panel overflow-hidden p-3 bg-gray-25 dark:bg-gray-800">
                                        <div class="block-header panel">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="text-none hover:text-primary duration-150" href="blog-category.html">Populer</a>
                                            </h2>
                                        </div>
                                        <div class="block-content">
                                ...
                                <div>
                                    <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                                        <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="text-none hover:text-primary duration-150" href="blog-category.html">Politik</a>
                                            </h2>                                            
                                        </div>
                                        <div class="block-content">
                                            <div class="row child-cols-6 g-2 gy-3 md:gx-3 md:gy-4">
                                                    ...
                                                    <article class="post type-post panel vstack gap-1 lg:gap-2">
                                                        <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                            <div class="featured-image uc-transition-scale-up uc-transition-opaque bg-gray-25 dark:bg-gray-800 ratio ratio-16x9">
                                                                <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-01.jpg" alt="The Rise of AI-Powered Personal Assistants: How They Manage" data-uc-img="loading: lazy">
                                                            </div>
                                                            <a href="blog-details.html" class="position-cover"></a>
                                                        </div>
                                                        <div class="post-header panel vstack gap-1">
                                                            <div class="post-meta panel hstack justify-start gap-1 fs-7 fw-medium text-gray-900 dark:text-white text-opacity-60 d-none md:d-flex z-1">
                                                                <div>
                                                                    <div class="post-category hstack gap-narrow fw-semibold">
                                                                        <a class="text-none hover:text-primary dark:text-primary duration-150" href="blog-category.html">Gadgets</a>
                                                                    </div>
                                                                </div>
                                                                <div class="sep d-none md:d-block">❘</div>
                                                                <div class="d-none md:d-block">
                                                ...
                                                <div>
                                                    <article class="post type-post panel vstack gap-1 lg:gap-2">
                                                        <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                            <div class="featured-image uc-transition-scale-up uc-transition-opaque bg-gray-25 dark:bg-gray-800 ratio ratio-16x9">
                                                                <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-02.jpg" alt="Tech Innovations Reshaping the Retail Landscape: AI Payments" data-uc-img="loading: lazy">
                                                            </div>
                                                            <a href="blog-details.html" class="position-cover"></a>
                                                        </div>
                                                        <div class="post-header panel vstack gap-1">
                                ...
                                <div>
                                    <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                                        <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="post-title text-none hover:text-primary duration-150" href="blog-category.html">Kesehatan</a>
                                            </h2>
                                        </div>
                                        <div class="block-content panel vstack gap-3">
                                            <div>
                                                <article class="post type-post panel vstack gap-1 lg:gap-2">
                                                    <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                        <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-16x9">
                                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-12.jpg" alt="AI-Powered Financial Planning: How Algorithms Revolutionizing" data-uc-img="loading: lazy">
                                                        </div>
                                                        <a href="blog-details.html" class="position-cover"></a>
                                                    </div>
                                                    <div class="post-header panel vstack gap-1">
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-13.jpg" alt="Tech Tools for your Time Management: Enhancing Productivity" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-14.jpg" alt="A Guide to The Rise of Gourmet Street Food: Trends and Top Picks" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-15.jpg" alt="Gaming in the Age of AI: Strategies for Startups" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                ...
                                <div>
                                    <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                                        <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="post-title text-none hover:text-primary duration-150" href="blog-category.html">Olahraga</a>
                                            </h2>
                                        </div>
                                        <div class="block-content panel vstack gap-3">
                                            <div>
                                                <article class="post type-post panel vstack gap-1 lg:gap-2">
                                                    <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                        <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-16x9">
                                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-04.jpg" alt="The Importance of Sleep: Tips for Better Rest and Recovery" data-uc-img="loading: lazy">
                                                        </div>
                                                        <a href="blog-details.html" class="position-cover"></a>
                                                    </div>
                                                    <div class="post-header panel vstack gap-1">
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-05.jpg" alt="The Future of Sustainable Living: Driving Eco-Friendly Lifestyles" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-09.jpg" alt="Hidden Gems: Underrated Travel Destinations Around the World" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                ...
                                <div>
                                    <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                                        <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="post-title text-none hover:text-primary duration-150" href="blog-category.html">Hukum</a>
                                            </h2>
                                        </div>
                                        <div class="block-content panel vstack gap-3">
                                            <div>
                                                <article class="post type-post panel vstack gap-1 lg:gap-2">
                                                    <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                        <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-16x9">
                                                            <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-08.jpg" alt="AI and Marketing: Unlocking Customer Insights" data-uc-img="loading: lazy">
                                                        </div>
                                                        <a href="blog-details.html" class="position-cover"></a>
                                                    </div>
                                                    <div class="post-header panel vstack gap-1">
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-10.jpg" alt="Eco-Tourism: Traveling Responsibly and Sustainably" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <article class="post type-post panel">
                                                    <div class="row child-cols g-2" data-uc-grid>
                                                        ...
                                                        <div class="col-auto">
                                                            <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                    <img class=" uc-transition-scale-up uc-transition-opaque media-cover uc-transition-scale-up uc-transition-opaque image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-11.jpg" alt="Solo Travel: Some Tips and Destinations for the Adventurous Explorer" data-uc-img="loading: lazy">
                                                                </div>
                                                                <a href="blog-details.html" class="position-cover"></a>
                                                            </div>
                                                        </div>
                                ...
                                <div>
                                    <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                                        <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="post-title text-none hover:text-primary duration-150" href="blog-category.html">Daerah</a>
                                            </h2>
                                        </div>
                                            ...
                                            <div class="block-left w-100 lg:w-3/4">
                                                <div>
                                                    <article class="post type-post panel vstack gap-1 lg:gap-2">
                                                        <div class="post-media panel uc-transition-toggle overflow-hidden">
                                                            <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-16x9">
                                                                <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-06.jpg" alt="Business Agility the Digital Age: Leveraging AI and Automation" data-uc-img="loading: lazy">
                                                            </div>
                                                            <a href="blog-details.html" class="position-cover"></a>
                                                        </div>
                                                        <div class="post-header panel vstack gap-1">
                                                    ...
                                                    <article class="post type-post panel">
                                                        <div class="row child-cols g-2" data-uc-grid>
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-05.jpg" alt="The Future of Sustainable Living: Driving Eco-Friendly Lifestyles" data-uc-img="loading: lazy">
                                                                    </div>
                                                                    <a href="blog-details.html" class="position-cover"></a>
                                                                </div>
                                                            </div>
                                                ...
                                                <div>
                                                    <article class="post type-post panel">
                                                        <div class="row child-cols g-2" data-uc-grid>
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="post-media panel overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-06.jpg" alt="Business Agility the Digital Age: Leveraging AI and Automation" data-uc-img="loading: lazy">
                                                                    </div>
                                                                    <a href="blog-details.html" class="position-cover"></a>
                                                    ...
                                                    <article class="post type-post panel">
                                                        <div class="row child-cols g-2" data-uc-grid>
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-07.jpg" alt="The Art of Baking: From Classic Bread to Artisan Pastries" data-uc-img="loading: lazy">
                                                                    </div>
                                                                    <a href="blog-details.html" class="position-cover"></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <article class="post type-post panel">
                                                        <div class="row child-cols g-2" data-uc-grid>
                                                            ...
                                                            <div class="col-auto">
                                                                <div class="post-media panel uc-transition-toggle overflow-hidden max-w-72px min-w-64px lg:min-w-72px">
                                                                    <div class="featured-image bg-gray-25 dark:bg-gray-800 ratio ratio-1x1">
                                                                        <img class=" uc-transition-scale-up uc-transition-opaque media-cover image" src="../assets/images/common/img-fallback.png" data-src="../assets/images/demo-two/posts/img-08.jpg" alt="AI and Marketing: Unlocking Customer Insights" data-uc-img="loading: lazy">
                                                                    </div>
                                                                    <a href="blog-details.html" class="position-cover"></a>
                                                                </div>
                                                            </div>
                                ...
                                <div class="lg:col-4">
                                    <div class="block-layout grid-layout vstack gap-2 xl:gap-3 panel overflow-hidden">
                                        <div class="block-header panel hstack justify-between px-2 py-1 bg-gray-800 text-white uc-dark">
                                            <h2 class="h6 lg:h5 m-0 text-inherit dark:text-white hstack gap-1">
                                                <span class="panel d-inline-block bg-primary w-8px h-8px translate-y-px"></span>
                                                <a class="post-title text-none hover:text-primary duration-150" href="blog-category.html">Nasional</a>
                                            </h2>
                                        </div>
                                        <div class="block-content panel vstack gap-3">
                                            <div>
                            ...
                            <div class="row child-cols lg:child-cols-2 justify-between g-4" data-uc-grid>
                                <div class="col-12 lg:col-5">
                                    <div class="vstack gap-3 dark:text-white">
                                        <a href="index.html">
                                            <img class=" uc-transition-scale-up uc-transition-opaque uc-logo w-80px text-gray-900 dark:text-white" src="../assets/images/demo-two/common/logo.svg" alt="News5" data-uc-svg>
                                        </a>
                                        ...
                                        <ul class="nav-x gap-2">
                                            <li>
                                                <a class="hover:text-gray dark:hover:text-gray-200 transition-colors duration-200" href="#fb"><i class="icon icon-2 unicon-logo-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a class="hover:text-gray dark:hover:text-gray-200 transition-colors duration-200" href="#x"><i class="icon icon-2 unicon-logo-x-filled"></i></a>
                                            </li>
                                            <li>
                                                <a class="hover:text-gray dark:hover:text-gray-200 transition-colors duration-200" href="#in"><i class="icon icon-2 unicon-logo-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a class="hover:text-gray dark:hover:text-gray-200 transition-colors duration-200" href="#yt"><i class="icon icon-2 unicon-logo-youtube"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="blog-category.html">Social</a></li>
                                                ...
                                                <li><a href="blog-category.html">Sports</a></li>
                                ...
                                <div>
                                    <div class="widget links-widget vstack gap-3">
                                        ...
                                        <div class="widgt-content">
                                            <ul class="nav-y gap-2 fs-6 fw-medium text-dark dark:text-white">
                                                <li><a href="blog-category.html">Podcats</a></li>
                                                <li><a href="blog-category.html">News TV</a></li>
                                                <li><a href="blog-category.html">National</a></li>
                                                <li><a href="blog-category.html">Global</a></li>
                                                <li><a href="blog-category.html">Dialogues</a></li>
        ...
        <script defer src="https://html.themewant.com/news5/assets/js/libs/jquery.min.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/libs/bootstrap.min.js"></script>

        <!-- include scripts -->
        <script defer src="https://html.themewant.com/news5/assets/js/libs/anime.min.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/libs/swiper-bundle.min.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/libs/scrollmagic.min.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/helpers/data-attr-helper.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/helpers/swiper-helper.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/helpers/anime-helper.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/helpers/anime-helper-defined-timelines.js"></script>
        <script defer src="https://html.themewant.com/news5/assets/js/uikit-components-bs.js"></script>

        <!-- include app script -->
        <script defer src="https://html.themewant.com/news5/assets/js/app.js"></script>
